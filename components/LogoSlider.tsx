  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 150 50" className="h-10 w-auto text-[#1a1a1a]" fill="none">
        ...
        <text x="44" y="38" fill="currentColor" fontSize="13" fontWeight="800" fontFamily="system-ui">Group</text>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 150 50" className="h-10 w-auto text-[#1a1a1a]" fill="none">
        ...
        <text x="42" y="30" fill="currentColor" fontSize="16" fontWeight="800" fontFamily="system-ui">Leipziger</text>
      </svg>
    ),
  },
];
